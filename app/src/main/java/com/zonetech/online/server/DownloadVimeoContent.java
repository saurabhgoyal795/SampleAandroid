...
public class DownloadVimeoContent {
    private DownloadVimeoContent(){}
    private static DownloadVimeoMediaTask downloadVimeoMediaTask;
    public static boolean isVimeoDownloading = false;
    public static String downloadVimeoVideoId = "";
    ...
    public static void downloadMedia(Context context, String videoUrl, String videoId, String videoJson){
        ...
        if(isVimeoDownloading){
            ...
            downloadVimeoVideoId = videoId;
            Intent intent = new Intent(ClassVideoListActivity.DOWNLOAD_REQUEST);
            intent.putExtra("type", "start");
            intent.putExtra("videoId", videoId);
            LocalBroadcastManager.getInstance(context).sendBroadcast(intent);
            if(downloadVimeoMediaTask != null){
                downloadVimeoMediaTask.cancel(true);
            }
            downloadVimeoMediaTask = new DownloadVimeoMediaTask(context);
            downloadVimeoMediaTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, videoUrl, videoId, videoJson);
        }
    }

    static class DownloadVimeoMediaTask extends AsyncTask<String, Integer, Boolean> {
        File file;
        ...
        public DownloadVimeoMediaTask(Context context){
